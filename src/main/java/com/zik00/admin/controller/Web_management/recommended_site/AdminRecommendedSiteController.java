package com.zik00.admin.controller.Web_management.recommended_site;
...
@RestController @RequestMapping("/api/admin/web-management/recommended-sites")
public class AdminRecommendedSiteController {
    private static final String TYPE="RECOMMENDED_SITE"; private final HomepageContentService service;
    public AdminRecommendedSiteController(HomepageContentService service){this.service=service;}
