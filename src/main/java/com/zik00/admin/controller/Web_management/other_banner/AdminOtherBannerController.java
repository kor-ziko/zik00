package com.zik00.admin.controller.Web_management.other_banner;
...
@RestController @RequestMapping("/api/admin/web-management/other-banners")
public class AdminOtherBannerController {
    private static final String TYPE="OTHER_BANNER"; private final HomepageContentService service;
    public AdminOtherBannerController(HomepageContentService service){this.service=service;}
