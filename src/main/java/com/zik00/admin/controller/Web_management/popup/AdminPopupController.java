package com.zik00.admin.controller.Web_management.popup;
...
@RestController @RequestMapping("/api/admin/web-management/popups")
public class AdminPopupController {
    private static final String TYPE="POPUP"; private final HomepageContentService service;
    public AdminPopupController(HomepageContentService service){this.service=service;}
