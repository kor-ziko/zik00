package com.zik00.admin.controller.Web_management.precaution;
...
@RestController @RequestMapping("/api/admin/web-management/precautions")
public class AdminPrecautionController {
    private static final String TYPE="PRECAUTION"; private final HomepageContentService service;
    public AdminPrecautionController(HomepageContentService service){this.service=service;}
